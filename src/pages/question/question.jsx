...
export default class MenuCom extends React.Component {
    state = {
        ...
        advancedSearch_created_by: "", // 创建人
        advancedSearch_assign: "", // 指派
        advancedSearch_model: "", // 模块
    ...
    advancedSearch_onOk = () => {
        ...
        this.advancedSearch_formRef.current.validateFields().then(values => {
            _this.setState({
                ...
                advancedSearch_created_by: values.advancedSearch_created_by === undefined ? "" : values.advancedSearch_created_by,
                advancedSearch_assign: values.advancedSearch_assign === undefined ? "" : values.advancedSearch_assign,
                advancedSearch_model: values.advancedSearch_model === undefined ? "" : values.advancedSearch_model,
    ...
    createQuestion_showModal = () => {
        ...
        this.setState({
            ...
            setTimeout(function () {
                ...
                _this.createQuestion_descriptionWangEditor.config.placeholder = '请输入描述内容';
    ...
    */
    ...
    checkQuestion_showModal = (data) => {
        ...
        this.setState({
            ...
            checkQuestion_initialValues: {
                ...
                checkQuestion_created_by: data.create_by,
                ...
                checkQuestion_model: data.model,
                ...
                checkQuestion_resolve: data.resolve,
            }
        }, function () {
            /**
             * 编辑器相关
             */
            setTimeout(function () {
                _this.wangEditor = new E(document.getElementById("checkQuestion_descriptionToolbar"), document.getElementById("checkQuestion_description"));
                ...
                _this.wangEditor.config.height = 'auto';
                ...
                _this.commentWangEditor.config.height = 100;
                ...
                _this.commentWangEditor.config.menus = [
                    'head',  // 标题
                    'bold',  // 粗体
                    'fontSize',  // 字号
                    'fontName',  // 字体
    ...
    checkQuestion_status_onChange = value => {
        this.setState({ checkQuestion_status: value });
    }
    ...
    getData(pageNumber, pageSize) {
        axios.get(`/api/bug/buginfo/?pageSize=${pageSize}&pageNumber=${pageNumber}&title=${this.state.title}&type=${this.state.advancedSearch_type}&status=${this.state.advancedSearch_status}&priority=${this.state.advancedSearch_priority}&created_by=${this.state.advancedSearch_created_by}&assign_by=${this.state.advancedSearch_assign}&model=${this.state.advancedSearch_model}&start_time=${this.state.advancedSearch_beginTime}&finish_time=${this.state.advancedSearch_finishTime}`).then(resp => {
            if (!resp.data.error) {
                let ajaxData = [];
                for (let i = 0; i < resp.data.data.length; i++) {
                    ajaxData.push({
                        ...
                        resolve: resp.data.data[i].resolve
                    });
                }
    ...
    render() {
        ...
        return (<div>
            ...
            >
                <Form labelCol={{ span: 9 }} wrapperCol={{ span: 15 }} ref={this.advancedSearch_formRef}>
                    ...
                    <Row>
                        ...
                        <Col span={12}>
                            <Form.Item label="创建人" name="advancedSearch_created_by">
                    ...
                    <Row>
                        ...
                        <Col span={12}>
                            <Form.Item label="模块" name="advancedSearch_model">
            ...
            >
                <Form labelCol={{ span: 6 }} wrapperCol={{ span: 18 }} ref={this.createQuestion_formRef}>
                    ...
                    <Row>
                        ...
                        <Col span={12}>
                            <Form.Item label="模块" name="createQuestion_model"
                                rules={[
                                    {
                                        required: true,
                                        message: "模块不能为空"
            ...
            <Modal
                title={"问题：" + this.state.checkQuestion_initialValues.checkQuestion_title}
                visible={this.state.checkQuestion_visible}
                width={660}
                onOk={this.checkQuestion_onSave}
            ...
            // footer={null}
            >
                <Form labelCol={{ span: 6 }} wrapperCol={{ span: 18 }} ref={this.checkQuestion_formRef} onFinish={this.checkQuestion_onSubmit} initialValues={this.state.checkQuestion_initialValues} style={{ height: 330, overflow: 'auto', paddingRight: 10 }}>
                    {/* <Form.Item labelCol={{ span: 3 }} wrapperCol={{ span: 21 }} label="主题" name="checkQuestion_title">
                        <Input disabled />
                    </Form.Item> */}
                    <Row>
                        <Col span={12}>
                            <Form.Item label="创建人" name="checkQuestion_created_by">
                                <Input disabled />
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                    ...
                    <Row>
                        ...
                        <Col span={12}>
                            <Form.Item label="模块" name="checkQuestion_model"
                                rules={[
                                    {
                                        required: true,
                                        message: "模块不能为空"
                    ...
                    {this.state.checkQuestion_status === "2" ? (
                    ...
                    <Form.Item labelCol={{ span: 3 }} wrapperCol={{ span: 21 }} label="描述" name="checkQuestion_description">
                        <div id="checkQuestion_descriptionToolbar" style={{ display: "none" }}></div>
                        <div id="checkQuestion_description" style={{ border: "1px solid #d9d9d9", borderRadius: 3, color: "#999999" }}></div>
                    </Form.Item>
                    ...
                    <Form.Item labelCol={{ span: 3 }} wrapperCol={{ span: 21 }} label="动态" name="checkQuestion_enclosure" style={{ marginBottom: 0 }}>
                        <Timeline style={{ background: "#f5f5f5", paddingLeft: "20px", paddingTop: "20px", paddingRight: "20px" }}>
                            {
                ...
                <Form labelCol={{ span: 0 }} wrapperCol={{ span: 24 }}>
                    <Form.Item wrapperCol={{ span: 24 }} name="checkQuestion_comment">
                        <div id="checkQuestion_comment"></div>
                    </Form.Item>
